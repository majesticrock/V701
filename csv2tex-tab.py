...
csv2textable("csv/d=2.4cm.csv", "Messwerte bei $x_0 = 2,4$ cm.", "d24cm", "S[table-format=4.0] S[table-format=5.0] S[table-format=4.0] S[table-format=1.2]")

csv2textable("csv/d=4.2cm.csv", "Messwerte bei $x_0 = 4,2$ cm.", "d42cm", "S[table-format=3.0] S[table-format=5.0] S[table-format=4.0] S[table-format=1.2]")